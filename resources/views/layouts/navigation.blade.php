<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('questions.user_posts')" :active="request()->routeIs('questions.user_posts')">
                        {{ __('けいこ歴') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                            ...
                            {{ __('けいこ歴') }}
												...
												<x-dropdown-link :href="route('search')">
                            {{ __('質問の検索') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('questions.index')" :active="request()->routeIs('questions.index')">
                {{ __('回答フォーム') }}
						...
						<x-responsive-nav-link :href="route('questions.user_posts')" :active="request()->routeIs('questions.user_posts')">
                {{ __('けいこ歴') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-gray-200">{{ Auth::user()->name }}{{' さん'}}</div>              
            </div>
